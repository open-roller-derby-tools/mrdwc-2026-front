...
const homeDivStyle = computed(() => getTeamColors(props.game.home_color, "var(--color-home)", isGameSpoiler(props.game)));
const awayDivStyle = computed(() => getTeamColors(props.game.away_color, "var(--color-away)", isGameSpoiler(props.game)));
