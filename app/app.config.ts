			...
			compoundVariants: [
				{
					...
					class: {
						...
						childLink:
							"font-shoulders text-xl text-toned text-white",
						viewport:
							"bg-blue-text/90 rounded-xl border-1 border-white/20 shadow-lg",
					},
				},
				{
					orientation: "horizontal",
		...
		slideover: {
			variants: {
				side: {
					right: {
						content:
							"right-0 inset-y-0 w-full max-w-none bg-blue-text",
						body: "p-0",
					},
				},
			},
